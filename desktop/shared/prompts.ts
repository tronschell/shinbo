...
- Before verification, resolve the installed toolchain and a writable temporary directory once, then reuse them. Use the repository's launch workflow and the actual endpoint printed by the owned process.
...
- Do the whole ask and only the ask; don't narrow it to what fits this turn. If part of it is blocked, finish the rest and say what you left and why. A related improvement discovered during inspection is not automatically part of the ask: report it separately unless it is necessary to deliver the requested outcome.
