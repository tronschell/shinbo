...
test "model list explains public-only and rejected-credential catalogs" {
    ...
    const cases = [_]struct {
        ...
        .{
            .snapshot = rejected,
            .text = "[models] 1 available\n - alpha\n[models] Your provider credential was rejected; using the public model catalog.\n",
            .body = "1 available\n - alpha\nYour provider credential was rejected; using the public model catalog.",
        },
        .{
    ...
    try std.testing.expect(std.mem.find(u8, quiet_body, "public model catalog") == null);
}
